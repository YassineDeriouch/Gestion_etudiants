...
<main>
    <div class="head-title">
        <div class="left">
            <h1 style="margin-top: 60px; font-weight: bold" ><b>Add role</b></h1>
            <ul class="breadcrumb">
                <li>
                ...
                <li>
                    <a class="active" href="addRole.jsp">Ajouter Role</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <form class="user" action="${pageContext.request.contextPath}/user/AddRole.action" method="post">
