...
<div class="container">
  <main>
    <div class="head-title">
      <div class="left">
        <h1 style="font-weight: bold">Modifier un etudiant</h1>
        <ul class="breadcrumb">
          <li>
          ...
          <li>
            <a class="active" href="ajouterEtudiant.jsp">modifier Etudiant</a>
          </li>
        </ul>
      </div>
    </div>
    <div class="container d-flex justify-content-center ">
      <form class="user" style="width: 100%;max-width: 300px;" action="${pageContext.request.contextPath}/user/modifierEtudiant.action" method="post" >
